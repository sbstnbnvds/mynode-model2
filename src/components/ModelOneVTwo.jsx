...
const ModelOneVTwo = () => {
  return (
    <div>
      ...
      <div className='container mx-auto max-w-5xl mb-20 px-2 md:px-8 text-3xl'>
        <div className='px-4 py-4 bg-card-color rounded-2xl border-2 border-card-border mb-6'>
          ...
          <div className='bg-gradient-to-r from-mn-gray-gradient to-mn-gray-banner h-8 w-4/12 rounded-full mb-10'></div>
          <p className='mb-3'>4 Core Intel CPU (Up to 2.7GHz)</p>
          <div className='bg-gradient-to-r from-mn-orange-gradient to-mn-orange h-8 w-full rounded-full'></div>

        </div>
        <div className='px-4 py-4 bg-card-color rounded-2xl border-2 border-card-border mb-6'>
          <p className='mb-3'>4GB RAM</p>
          <div className='bg-gradient-to-r from-mn-gray-gradient to-mn-gray-banner h-8 w-5/12 rounded-full mb-10'></div>
          <p className='mb-3'>8GB RAM</p>
          <div className='bg-gradient-to-r from-mn-orange-gradient to-mn-orange h-8 w-10/12 rounded-full'></div>
        </div>
        <div className='px-4 py-4 bg-card-color rounded-2xl border-2 border-card-border mb-6'>
        ...
        <div className='px-4 py-4 bg-card-color rounded-2xl border-2 border-card-border mb-6'>
          ...
          <div className='bg-gradient-to-r from-mn-gray-gradient to-mn-gray-banner h-8 w-2/5 rounded-full mb-10'></div>
