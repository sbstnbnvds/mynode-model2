    ...
    <div>
      <h2 className='text-7xl font-normal text-center mb-12'>
        <span className='relative me-4'>Model One
          <div className='absolute inset-x-0 h-3.5 flex justify-center'>
      ...
      <div className='container mx-auto mb-20 px-20 text-3xl'>
        <div className='px-20 py-20 bg-card-color rounded-2xl border-2 border-card-border mb-6'>
